    ...
    stages {
        stage('Build'){
            steps{
                ...
                sh 'rm -d lib'
                sh 'mkdir lib'
                sh 'cd lib/ ; curl https://repo1.maven.org/maven2/org/junit/platform/junit-platform-console-standalone/1.7.0/junit-platform-console-standalone-1.7.0-all.jar'
